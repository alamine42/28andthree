...
// E11: shared coaching template. Clean route renders current season; the
// /s/[season] wrapper renders past seasons. Segments/4th-down data are
// season-scoped in the DAL; the empty state covers seasons without
// rollups. Plan §3.4.
...
export async function CoachingPage({
  season,
  historical,
}: {
  season: number;
