...
function InsufficientSampleChip({ plays }: { plays: number }) {
  ...
  // in sync. The rank and EPA still render; the chip says they rest on a
  // thin sample and will move.
  return (
    <span
      title={`${plays} plays — below the 30-play season floor; rank is provisional (SPEC §3.5a)`}
